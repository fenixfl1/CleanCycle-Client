...
export const WEB_API_PATH_GET_MY_POST = 'posts/my_posts';
export const WEB_API_PATH_GET_SAVED_POST = 'posts/get_saved_posts';
export const WEB_API_PATH_SAVE_POST = 'posts/save_post';
export const WEB_API_PATH_GET_POSTS = 'posts/get_posts';
export const WEB_API_PATH_BLOCK_AUTHOR = 'posts/block_author';
...
export const WEB_API_PATH_LIKE_POST = 'posts/like_post';
...
export const WEB_API_PATH_FOLLOW_USER = 'users/follow_user';
...
export const PATH_POSTS_CREATE_POSTS = '/posts/create_post';
export const PATH_REGISTER_USER = '/register_user';
export const PATH_RECYCLING_POINTS = '/recycling_points';
export const PATH_EXCHANGES = '/exchanges';
